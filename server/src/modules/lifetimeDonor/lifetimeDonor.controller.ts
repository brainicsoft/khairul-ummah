...
export const createLifetimeDonorController: RequestHandler = catchAsync(
  async (req, res) => {
...
export const getAllLifetimeDonorController: RequestHandler = catchAsync(
  async (req, res) => {
...
export const getLifetimeDonorByIdController: RequestHandler = catchAsync(
  async (req, res) => {
...
export const updateLifetimeDonorByIdController: RequestHandler = catchAsync(
  async (req, res) => {
    const result = await updateLifetimeDonorByIdService(
      req.params.id,
      req.body,
    );
    sendResponse(res, {
...
export const deleteLifetimeDonorByIdController: RequestHandler = catchAsync(
  async (req, res) => {
