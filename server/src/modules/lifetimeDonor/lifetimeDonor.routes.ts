...
import {
  createLifetimeDonorController,
  deleteLifetimeDonorByIdController,
  getAllLifetimeDonorController,
  updateLifetimeDonorByIdController,
} from './lifetimeDonor.controller';
