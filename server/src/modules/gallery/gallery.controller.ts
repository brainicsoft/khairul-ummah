...
export const createGalleryController: RequestHandler = catchAsync(
  async (req, res) => {
...
export const getAllGalleryController: RequestHandler = catchAsync(
  async (req, res) => {
    const { result, meta } = await getAllGalleryService(req.query);
    sendResponse(res, {
      status: 200,
      success: true,
...
export const getGalleryByIdController: RequestHandler = catchAsync(
  async (req, res) => {
...
export const updateGalleryByIdController: RequestHandler = catchAsync(
  async (req, res) => {
    let formattedData = req.body;
...
export const deleteGalleryByIdController: RequestHandler = catchAsync(
  async (req, res) => {
