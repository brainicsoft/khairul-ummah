...
import {
  createCommiteeController,
  deleteCommiteeByIdController,
  getAllCommiteeController,
  getAllRoleYpeController,
  updateCommiteeByIdController,
} from './commitee.controller';
