...
import {
  createDonationProjectController,
  deleteDonationProjectByIdController,
  getAllActiveDonationProjectController,
  getAllDonationProjectController,
  getAllDonationSlugsController,
  getDonationProjectBySlugContoller,
  updateDonationProjectByIdController,
} from './donationProject.controller';
...
donationProjectRoutes.post(
  '/request',
  uploader({ image: 'single' }),
  formValidator,
  createDonationProjectController,
);
donationProjectRoutes.delete(
  '/:id',
  auth('admin'),
  deleteDonationProjectByIdController,
);
donationProjectRoutes.patch(
  '/:id',
  auth('admin'),
  uploader({ image: 'single' }),
  formValidator,
