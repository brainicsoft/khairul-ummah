...
export const createDonationProjectController: RequestHandler = catchAsync(
  async (req, res) => {
    ...
    const existingTitle = await DonationProject.findOne({
...
export const getAllDonationProjectController: RequestHandler = catchAsync(
  async (req, res) => {
...
export const getAllActiveDonationProjectController: RequestHandler = catchAsync(
  async (req, res) => {
    const { result, meta } = await getAllActiveDonationProjectService(
      req.query,
    );
    sendResponse(res, {
      status: 200,
...
export const getDonationProjectByIdController: RequestHandler = catchAsync(
  async (req, res) => {
...
export const getDonationProjectBySlugContoller: RequestHandler = catchAsync(
  async (req, res) => {
...
export const updateDonationProjectByIdController: RequestHandler = catchAsync(
  async (req, res) => {
    let formattedData = req.body;
    ...
    const result = await updateDonationProjectByIdService(
      req.params.id,
      formattedData,
    );
    sendResponse(res, {
...
export const deleteDonationProjectByIdController: RequestHandler = catchAsync(
  async (req, res) => {
...
export const getAllDonationSlugsController: RequestHandler = async (
  req,
  res,
) => {
  try {
