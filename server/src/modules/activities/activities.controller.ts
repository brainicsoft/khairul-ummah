...
export const createActivitiesController: RequestHandler = catchAsync(
  async (req, res) => {
...
export const getAllActivitiesController: RequestHandler = catchAsync(
  async (req, res) => {
...
export const getActivitiesByIdController: RequestHandler = catchAsync(
  async (req, res) => {
...
export const updateActivitiesByIdController: RequestHandler = catchAsync(
  async (req, res) => {
    let formattedData = req.body;
    ...
    const result = await updateActivitiesByIdService(
      req.params.id,
      formattedData,
    );
    sendResponse(res, {
...
export const deleteActivitiesByIdController: RequestHandler = catchAsync(
  async (req, res) => {
...
export const getActivitiesBySlugController: RequestHandler = catchAsync(
  async (req, res) => {
