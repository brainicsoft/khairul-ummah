...
export const getAllBlogController: RequestHandler = catchAsync(
  async (req, res) => {
...
export const getBlogByIdController: RequestHandler = catchAsync(
  async (req, res) => {
...
export const getBlogBySlugController: RequestHandler = catchAsync(
  async (req, res) => {
...
export const updateBlogByIdController: RequestHandler = catchAsync(
  async (req, res) => {
    let formattedData = req.body;
    ...
    const result = await updateBlogByIdService(req.params.id, formattedData);
    sendResponse(res, {
      status: 200,
      success: true,
...
export const deleteBlogByIdController: RequestHandler = catchAsync(
  async (req, res) => {
