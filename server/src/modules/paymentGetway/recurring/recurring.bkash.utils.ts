...
export const generateBkashAutopayHeaders = (
  method: string,
  urlPath: string,
  body: any,
  appKey: string,
  ...
  try {
    console.debug(
      '[generateBkashAutopayHeaders] host, urlPath, stringToSign preview:',
      { host, urlPath, stringToSign: String(stringToSign).slice(0, 300) },
    );
  } catch (e) {}
