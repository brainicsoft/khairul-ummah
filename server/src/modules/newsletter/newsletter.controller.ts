...
export const createNewsletterController: RequestHandler = catchAsync(
  async (req, res) => {
    try {
...
export const getAllNewsletterController: RequestHandler = catchAsync(
  async (req, res) => {
...
export const getNewsletterByIdController: RequestHandler = catchAsync(
  async (req, res) => {
...
export const updateNewsletterByIdController: RequestHandler = catchAsync(
  async (req, res) => {
...
export const deleteNewsletterByIdController: RequestHandler = catchAsync(
  async (req, res) => {
