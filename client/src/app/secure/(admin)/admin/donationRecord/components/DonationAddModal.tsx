...
export default function DonationAddModal({ isOpen, onClose, onAdd }: DonationAddModalProps) {
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
        ...
        >
          ...
          <div className="sticky top-0 z-50 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-600 flex items-center justify-between p-6">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-1">নতুন ডোনেশন যোগ করুন</h2>
          ...
          `}</style>
            <DonationAddForm onClose={onClose} onAdd={onAdd} setIsLoading={setIsLoading} />
          </div>
          ...
          <div className="sticky bottom-0 z-50 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-600 p-4 flex justify-end gap-4">
            ...
            <Button className="cursor-pointer" type="submit" form="donation-add-form" disabled={isLoading}>
